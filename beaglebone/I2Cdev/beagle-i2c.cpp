// This file and beagle-i2c.cpp are from Ajay Kumarkannan's Beaglebone-I2C,
// (http://github.com/ajaykumarkannan/Beaglebone-I2C)
//
// I've just renamed them from i2c.cpp and i2c.h to avoid confusion with
// other i2c stuff. I've also slightly modified the buffer size, the 
// ability to read any number of bytes instead of just 7 bytes and the
// error reporting. But all credit goes to him for the amazing simplicity
// of the class!
//
// Greetings, claus rosito (http://github.com/clausqr)
//
#include "beagle-i2c.h"
#include <iostream>
using namespace std;
